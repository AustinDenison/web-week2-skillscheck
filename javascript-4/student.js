...
const faveColors = ['purple', 'black', 'red'] // CODE HERE
...
const me = {
    firstName: 'austin',
    superHeroName: 'agile austin',
    homeTown: 'magna',
    superPowers: ['super speed', 'teleport', 'super strength'],
...
const homeTown = me.homeTown // CODE HERE
